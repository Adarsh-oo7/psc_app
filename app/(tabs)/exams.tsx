...
// CORRECTED: The card now accepts an `isDarkMode` prop to style itself
...
export default function ExamsScreen() {
    // CORRECTED: Get the theme from the context
    ...
    return (
        // CORRECTED: The main container and its content now have dark mode styles
        <ScrollView style={[styles.container, isDarkMode && styles.containerDark]} contentContainerStyle={{ paddingBottom: 100 }}>
            <Text style={[styles.headerTitle, isDarkMode && styles.headerTitleDark]}>Select an Exam</Text>
            <TextInput
...
const styles = StyleSheet.create({
    ...
    headerTitle: { fontSize: 28, fontWeight: 'bold', paddingHorizontal: 16, paddingTop: 50, paddingBottom: 8, color: '#1f2937' },
